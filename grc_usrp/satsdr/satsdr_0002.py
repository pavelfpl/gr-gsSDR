...
class gr_vzlu_test(gr.top_block):
    ...
    def __init__(self):
        ...
        self.satellites_u482c_deframer_0 = satellites.components.deframers.u482c_deframer(syncword_threshold = 3, options="")
        self.satellites_afsk_demodulator_0 = satellites.components.demodulators.afsk_demodulator(baudrate = 4800, samp_rate = samp_rate, iq = True, af_carrier = 3600, deviation = -1200, options="")
        self.gsSDR_http_transfer_sink_0 = gsSDR.http_transfer_sink('localhost', '8080', '/gs/tm', 0, 2, '', '')
        ...
        self.msg_connect((self.satellites_u482c_deframer_0, 'out'), (self.gsSDR_http_transfer_sink_0, 'in'))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.blocks_multiply_xx_0, 0), (self.satellites_afsk_demodulator_0, 0))
        self.connect((self.satellites_afsk_demodulator_0, 0), (self.satellites_u482c_deframer_0, 0))
...
def main(top_block_cls=gr_vzlu_test, options=None):
    tb = top_block_cls()
