...
class gr_grbalpha_test(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "gr-grbalpha test GUI")
        ...
        self.gsSDR_http_transfer_sink_0 = gsSDR.http_transfer_sink('localhost', '8080', '/gs/tm', 0, 3, '', '')
        self.gsSDR_gs_doppler_correction_0 = gsSDR.gs_doppler_correction('localhost', '4534', 0, freq)
        ...
        self.msg_connect((self.satellites_ax25_deframer_0, 'out'), (self.gsSDR_http_transfer_sink_0, 'in'))
...
def main(top_block_cls=gr_grbalpha_test, options=None):
    tb = top_block_cls()
